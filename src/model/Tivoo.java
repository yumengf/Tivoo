...
public class Tivoo {
	...
	public Tivoo() throws ClassNotFoundException
	{
		processor = new Process();
	}
	
	public void loadFile(String file) throws ClassNotFoundException, JDOMException, IOException, InstantiationException, IllegalAccessException
	{
	...
	public void aggregateFiles(String file)throws ClassNotFoundException, JDOMException, IOException, InstantiationException, IllegalAccessException
	{
		ParserFactory factory = new ParserFactory();
		Parser parser = factory.getParser(file);
		Element rootNode = factory.getMyRoot();
		list.addAll( parser.parse(rootNode));
	}
	
	public void filter(String filter, List<?> l) throws Exception
	{
		list = processor.filter(filter, l, list);
	}
